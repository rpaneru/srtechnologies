<div id="pagecontent">
    ...
    if ($_GET['major_location_name'] <> "")
    {
        $xtrasql .= " AND major_location_name LIKE '%" . $_GET['major_location_name'] . "%' ";
    }
    $xtrasql .= $xtraquery;
    $query = "SELECT * from locations_major " . $xtrasql . " ";
    //echo $query;
    ...
    $default_sort_column = "major_location_id";
    ...
    <div class="block-start popwide">
	    ...
	    <tr>
            ...
            <th>&nbsp;<?php draw_record_sorter("Organization Name","major_location_name",$page_query_string,$system_uri); ?>&nbsp;</th>
            <th>&nbsp;State&nbsp;</th>
            <th width="40px">&nbsp;</th>
	    </tr>
		<?php 
        ...
        <tr>
            ...
            <td class="row2" align="left">
    	        <?php echo stripslashes($row_rsnf['major_location_name']); ?>
            </td>
            
            <td class="row2" align="left">
	            <?php echo get_val_col( 'master_states_india', 'state_name', 'state_id', $row_rsnf['state_id']); ?>
            </td>
            
            <td class="row1 Small" align="center"  nowrap="nowrap" style="vertical-align:middle">
            <?php load_service_element($_SESSION['NF_Username'], $_GET['do'], "&major_location_id=" . $row_rsnf['major_location_id'] . "","Rows","&major_location_id=" . $row_rsnf['major_location_id'].""); ?>   
