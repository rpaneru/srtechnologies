...
$xtrasql .= " AND  id  = '" . $_GET['service_group_id'] . "' ";
}
if ($_GET['name'] <> ""){
$xtrasql .= " AND service_group_name LIKE '%" . $_GET['service_group_name'] . "%' ";
}


$xtrasql .= $xtraquery;
$query = "SELECT * from services_group" . $xtrasql . " ";
...
$default_sort_column = "sort_order";
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	...
	<table width="100%" cellspacing="1">
		...
		<td class="nav" valign="middle" nowrap="nowrap" align="right">
					...
					<a class="galleylink" href="core.php?do=view_service_groups&element=create"><span>Add a New Service Group</span></a>        </td>
					</tr>
				</tbody></table>
	    </td>
...
<table class="tablebg genmed" width="100%" cellspacing="0" cellpadding="0" border="0">
        ...
        <th>&nbsp;<?php draw_record_sorter("service Group Name","service_group_name",$page_query_string,$system_uri); ?>&nbsp;</th>
 		<th>&nbsp;<?php draw_record_sorter("Description","service_group_description",$page_query_string,$system_uri); ?>&nbsp;</th>
		<th width="40px">&nbsp;</th>
	</tr>
 <?php 
	$i = 1;
	...
	do {
			if($row_rsnf['service_group_name']!="Service Group")
			{
	  ?>
			<tr>
          ...
          <?php echo stripslashes($row_rsnf['service_group_name']); ?>
            ...
            <td class="row2" align="left">
            <?php echo $row_rsnf['service_group_description']; ?>
            </td>
         
           
			<td class="row1 Small" align="center"  nowrap="nowrap" style="vertical-align:middle">
                <a class="btnlite" href="core.php?do=view_service_groups&element=edit&service_group_id=<?php echo $row_rsnf['id'];?>">Edit </a>
<a class="btnlite" href="core.php?do=view_service_groups&element=delete&service_group_id=<?php echo $row_rsnf['id'];?>" onclick="return confirmLink(this, 'delete this service group?')">Delete </a>
		</tr>
		 <?php 
	  $i++; 
	$k++; 
